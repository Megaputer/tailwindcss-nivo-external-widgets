...
import { CardWidget } from './view';

import * as css from './styles.module.css';

class CardWidgetWidget implements IWidget {
  ...
  private updateContainer() {
    if (this.root && this.requestor)
      this.root.render(<CardWidget requestor={this.requestor} />);
  }
...
export const create = (args: WidgetArgs) => new CardWidgetWidget(args);
